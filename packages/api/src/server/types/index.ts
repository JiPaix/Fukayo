...
export type ServerToClientEvents = {
  ...
  showImports: (id: number, /** number = nb of mangas to expect */ manga:number|importErrorMessage|ImportResults[]|ImportResults|CantImportResults|CantImportResults[]|TaskDone) => void;
